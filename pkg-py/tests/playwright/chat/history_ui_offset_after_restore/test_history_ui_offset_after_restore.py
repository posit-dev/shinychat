...
# then misplaces/drops the extra across restore cycles — the F3 "positional
# drop/dup" class from roborev 1063, dispositioned as transient: the
# exchange-tree rewrite (kata epic 6d0d) captures every server-sent message
# eagerly and resolves this by construction. strict=True so the suite flags
# when 6d0d (or any fix) makes it pass again.
