...
* Fixed conversation history crashing every Shiny session after the first on Posit Connect when falling back to server bookmark storage (`RuntimeError: Directory ... already exists; cannot overwrite existing bookmark directory`).
