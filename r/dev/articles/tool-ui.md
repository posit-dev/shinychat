...
Expand the tool result card to see the forecast as a table. Notice the
fullscreen toggle button in the card body—clicking it expands the card
...
- **`full_screen = TRUE`**: Add a fullscreen toggle button to the tool
  result card.
