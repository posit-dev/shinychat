...
## Pairing with [`chat_server()`](https://posit-dev.github.io/shinychat/r/reference/chat_app.md)
...
The button provides the surface, so a bare glyph gets the same
filled-circle treatment as the default arrow:
