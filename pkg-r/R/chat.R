...
#'
#' **The `greeting_requested` input.** When the chat is visible, has no
#' messages, and has no greeting set, Shiny fires
...
#' ```
#'
#' This input fires on first load and again after [chat_clear()]
