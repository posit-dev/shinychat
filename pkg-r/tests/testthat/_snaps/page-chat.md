          ...
          <div class="shiny-chat-page-body">
            ...
            <main class="shiny-chat-page-main">
              <section class="shiny-chat-page-panel shiny-chat-page-home" data-page-value="__home__" data-sidebar-key="default" data-page-toolbar-source="home">
                <shiny-chat-container class="html-fill-item html-fill-container" data-app-role="primary" data-require-bs-caller="chat_ui" data-require-bs-version="5" fill icon-assistant="" id="chat" max-attachment-size="31457280" placeholder="Enter a message..." style="--_chat-width:min(clamp(680px, 50vw, 760px), 100%);height:100%;" submit-key="enter+modifier">
