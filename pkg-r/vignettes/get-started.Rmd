...
Use `chat$on_user_input()` when the model needs extra context for each message.
This works well for retrieval-augmented generation and apps where the model
acts on the current document or dashboard state.
...
server <- function(input, output, session) {
  ...
  chat$on_user_input(function(contents) {
...
in the order that you register them.
