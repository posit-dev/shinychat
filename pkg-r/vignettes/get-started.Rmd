...
Navigation pages have no toolbar by default. Set `toolbar = TRUE` to move the
same toolbar supplied to `page_chat()` into the selected page, or supply UI for
a page-specific toolbar. The toolbar subtree moves without resetting its Shiny
inputs or outputs; use `FALSE`, rather than `NULL`, when no toolbar is needed.
