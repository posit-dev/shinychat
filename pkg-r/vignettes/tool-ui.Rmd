...
- **`open = TRUE`**: Open the drill-down card by default once the result settles.
   ...
   This is most useful when you've [customized the drill-down content](#rich-content-in-the-drill-down-card) to include an `{htmlwidget}` or other rich content that users should see immediately.
