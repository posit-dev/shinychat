...
Notice the fullscreen toggle button in the card header---clicking it expands the card to fill the viewport.
...
- **`full_screen = TRUE`**: Add a fullscreen toggle button to the tool result card header.

   When clicked, the card expands to fill the entire viewport, making it easy to inspect large or detailed content like maps, tables, and plots. Users can exit fullscreen by clicking the toggle again or pressing the `Escape` key.
