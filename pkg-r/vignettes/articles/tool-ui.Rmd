...
On it's own, the tool doesn't need any arguments, but we include a `` `_intent` `` argument in the tool function and we include a description to explain its purpose.
